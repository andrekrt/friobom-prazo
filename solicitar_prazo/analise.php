...
if(isset($_SESSION['idUsuario']) && empty($_SESSION['idUsuario']) == false && $_SESSION['tipoUsuario']==1){
    ...
    $atualiza = $db->query("UPDATE solicitacoes_prazo SET status_solicitacao = '$status_solicitacao', data_aprovocao = '$data_aprovacao', serasa = '$serasa', obs_analise = '$obsAnalise' WHERE idsolicitacoes_prazo = $idSolicitacao ");
